...
# টোকেন এনভায়রনমেন্ট ভেরিয়েবল থেকে নেওয়া
...
Welcome! I can help you lookup information about phone numbers.

*How to use:*
Send me a Bangladeshi phone number like:
`8801838XXXXXX`

Type /cancel to abort any operation.
